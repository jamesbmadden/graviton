 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const k=new class{handleAttributeExpressions(e,t,n,s){const i=t[0];return"."===i?new P(e,t.slice(1),n).parts:"@"===i?[new A(e,t.slice(1),s.eventContext)]:"?"===i?[new x(e,t.slice(1),n)]:new b(e,t,n).parts}handleTextExpression(e){return new w(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
