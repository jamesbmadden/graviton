...
(window.litElementVersions||(window.litElementVersions=[])).push("2.0.1");const at=t=>t.flat?t.flat(1/0):function t(e,n=[]){for(let s=0,i=e.length;s<i;s++){const i=e[s];Array.isArray(i)?t(i,n):n.push(i)}return n}(t);class lt extends Z{static finalize(){super.finalize(),this._styles=this.hasOwnProperty(JSCompiler_renameProperty("styles",this))?this._getUniqueStyles():this._styles||[]}static _getUniqueStyles(){const t=this.styles,e=[];if(Array.isArray(t)){at(t).reduceRight((t,e)=>(t.add(e),t),new Set).forEach(t=>e.unshift(t))}else t&&e.push(t);return e}initialize(){super.initialize(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?st?this.renderRoot.adoptedStyleSheets=t.map(t=>t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){super.update(t);const e=this.render();e instanceof _&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){}}lt.finalized=!0,lt.render=((t,e,n)=>{const s=n.scopeName,i=V.has(e),r=e instanceof ShadowRoot&&q&&t instanceof _,a=r&&!$.has(s),l=a?document.createDocumentFragment():e;if(((t,e,n)=>{let s=V.get(e);void 0===s&&(o(e,e.firstChild),V.set(e,s=new w(Object.assign({templateFactory:k},n))),s.appendInto(e)),s.setValue(t),s.commit()})(t,l,Object.assign({templateFactory:F(s)},n)),a){const t=V.get(l);V.delete(l),t.value instanceof y&&H(l,t.value.template,s),o(e,e.firstChild),e.appendChild(l),V.set(e,t)}!i&&r&&window.ShadyCSS.styleElement(e.host)})},function(t,e,n){"use strict";t.exports=function(t){var e=[];return e.toString=function(){return this.map(function(e){var n=function(t,e){var n=t[1]||"",s=t[3];if(!s)return n;if(e&&"function"==typeof btoa){var i=(o=s,"/*# sourceMappingURL=data:application/json;charset=utf-8;base64,"+btoa(unescape(encodeURIComponent(JSON.stringify(o))))+" */"),r=s.sources.map(function(t){return"/*# sourceURL="+s.sourceRoot+t+" */"});return[n].concat(r).concat([i]).join("\n")}var o;return[n].join("\n")}(e,t);return e[2]?"@media "+e[2]+"{"+n+"}":n}).join("")},e.i=function(t,n){"string"==typeof t&&(t=[[null,t,""]]);for(var s={},i=0;i<this.length;i++){var r=this[i][0];null!=r&&(s[r]=!0)}for(i=0;i<t.length;i++){var o=t[i];null!=o[0]&&s[o[0]]||(n&&!o[2]?o[2]=n:n&&(o[2]="("+o[2]+") and ("+n+")"),e.push(o))}},e}},,,,function(t,e,n){(t.exports=n(1)(!1)).push([t.i,"/**\n * This Source Code Form is subject to the terms of the Mozilla Public\n * License, v. 2.0. If a copy of the MPL was not distributed with this\n * file, You can obtain one at http://mozilla.org/MPL/2.0/.\n */\n/**\n * This Source Code Form is subject to the terms of the Mozilla Public\n * License, v. 2.0. If a copy of the MPL was not distributed with this\n * file, You can obtain one at http://mozilla.org/MPL/2.0/.\n */\nselect {\n  height: 3.5rem;\n  width: 100%;\n  font-size: 16pt;\n  padding-left: 8px;\n  background: #fff;\n  border: 1px solid #bdbdbd;\n  border-radius: 4px;\n  cursor: pointer;\n  background-color: transparent;\n  -webkit-appearance: none;\n}\n.select-container {\n  position: relative;\n  margin-top: 12px;\n}\n.select-label {\n  z-index: 1;\n  position: absolute;\n  top: 16px;\n  left: 2px;\n  color: #222;\n  background: #fff;\n  -webkit-transition: font-size 0.2s cubic-bezier(1, 0, 0, 1), color 0.2s cubic-bezier(1, 0, 0, 1), -webkit-transform 0.2s cubic-bezier(1, 0, 0, 1);\n  transition: font-size 0.2s cubic-bezier(1, 0, 0, 1), color 0.2s cubic-bezier(1, 0, 0, 1), -webkit-transform 0.2s cubic-bezier(1, 0, 0, 1);\n  transition: transform 0.2s cubic-bezier(1, 0, 0, 1), font-size 0.2s cubic-bezier(1, 0, 0, 1), color 0.2s cubic-bezier(1, 0, 0, 1);\n  transition: transform 0.2s cubic-bezier(1, 0, 0, 1), font-size 0.2s cubic-bezier(1, 0, 0, 1), color 0.2s cubic-bezier(1, 0, 0, 1), -webkit-transform 0.2s cubic-bezier(1, 0, 0, 1);\n  -webkit-transform: translate(4px, -24px);\n          transform: translate(4px, -24px);\n  font-size: 12px;\n  pointer-events: none;\n}\nselect:focus {\n  outline: none;\n  border: 1px solid #f44336;\n}\nselect:focus ~ .select-label {\n  color: #f44336;\n}\n.material-icons {\n  font-family: 'Material Icons';\n  font-weight: normal;\n  font-style: normal;\n  display: inline-block;\n  line-height: 1;\n  text-transform: none;\n  letter-spacing: normal;\n  word-wrap: normal;\n  white-space: nowrap;\n  direction: ltr;\n  -webkit-font-smoothing: antialiased;\n  text-rendering: optimizeLegibility;\n  -moz-osx-font-smoothing: grayscale;\n  -webkit-font-feature-settings: 'liga';\n          font-feature-settings: 'liga';\n}\n.drop-icon {\n  position: absolute;\n  font-size: 1.5rem;\n  right: 0.25rem;\n  top: 1rem;\n  pointer-events: none;\n}\n",""])},,,function(t,e,n){"use strict";n.r(e);var s=n(0),i=n(5),r=n.n(i);customElements.define("gvt-dropdown",class extends s.a{static get properties(){return{options:{type:Array},value:{type:String}}}static get styles(){return Object(s.b)([r.a.toString()])}connectedCallback(){super.connectedCallback(),this.value=this.options[0]}render(){return s.c`
      <div class="select-container">
        <select id="select" @input=${t=>{this.value=t.target.value,this.dispatchEvent(new Event("input"))}} @change=${t=>this.dispatchEvent(new Event("change"))}>
          ${this.options.map(t=>s.c`<option>${t}</option>`)}
        </select>
